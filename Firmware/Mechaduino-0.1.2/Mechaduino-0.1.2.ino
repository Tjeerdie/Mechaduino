...
{                         
  ...
  delay(1000);                      // This delay seems to make it easier to establish a connection when the Mechaduino is configured to start in closed loop mode.  
...
void loop()                 // main loop
{
  ...
  //pythonInterface();          //Use this to fine tune control loops with python GUI
