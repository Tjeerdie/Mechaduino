...
bool log_position = false;      //for step response, under development...
bool log_velocity = false;      //for step response, under development...
bool log_torque = false;      //for step response, under development...
bool log_error = false;      //for step response, under development...

//for step response
float StepAmplitude = 90.0;      //for step response, under development...
int StepStart = 5;      //for step response, under development...
int StepEnd = 40;      //for step response, under development...
float log_yw[LoggerSize];      //for step response, under development...
float log_v[LoggerSize];      //for step response, under development...
float log_u[LoggerSize];      //for step response, under development...
float log_r[LoggerSize];      //for step response, under development...
bool ResetLogger = false;
